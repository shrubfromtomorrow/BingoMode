...
namespace BingoMode.BingoChallenges
{
    ...
    public class WatcherBingoSpinningTopChallenge : BingoChallenge
    {
        ...
        {
            Phrase phrase = new([[new Icon("echo_icon"), specific.Value ? new Verse(spinner.Value) : new Counter(current, amount.Value)]]);
        ...
        public override Challenge Generate()
        {
            return new WatcherBingoSpinningTopChallenge
            {
                ...
                spinner = new(ChallengeUtils.SpinningTopSpots[Random.Range(0, ChallengeUtils.SpinningTopSpots.Length)], "Region", 1, listName: "spinners"),
