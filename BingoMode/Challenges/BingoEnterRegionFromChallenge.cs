...
namespace BingoMode.Challenges
{
    ...
    //        {
    //            from = new(regiones[UnityEngine.Random.Range(0, regiones.Length)], "From", 0, listName: "regionsreal"),
    //            to = new(regiones[UnityEngine.Random.Range(0, regiones.Length)], "To", 0, listName: "regionsreal")
    //        };
    //
    //        return ch;
    //    }
    ...
    //
    //        string[] worlds = gateName.ToUpperInvariant().Split('_');
    ...
    //    {
    //        //On.RegionGate.NewWorldLoaded += RegionGate_NewWorldLoaded3;
    //    }
    //
