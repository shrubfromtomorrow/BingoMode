    ...
    public class BingoModOptions : OptionInterface
    {
        ...
        public override void Initialize()
        {
            ...
            optionse = new UIelement[]
            {
                ...
                new OpLabel(10f, 313f, "Play custom music in bingo menu:") {alignment = FLabelAlignment.Left},
                new OpCheckBox(PlayMenuSong, 288f, 310f),
                
                new OpLabel(10f, 273f, "Play custom music when game ends:") {alignment = FLabelAlignment.Left},
                new OpCheckBox(PlayEndingSong, 288f, 270f),
                
                new OpLabel(10f, 233f, "Play custom music when your team is losing:") {alignment = FLabelAlignment.Left},
                new OpCheckBox(PlayDangerSong, 288f, 230f)
            };
